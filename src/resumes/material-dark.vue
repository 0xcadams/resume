...
<div class="resume">
  <div class="leftCol m_box">
    ...
    <a v-if="person.contact.website" :href="'https://'+person.contact.website" target="_blank">
      <div class="item">
        <div class="icon">
    ...
    <div class="item">
      ...
      <div v-for="education in person.education.history" :key="education.degree">
        <a :href="education.map" target="_blank" class="item">
          <div class="icon">
            <i class="fa fa-map-marker"></i>
          </div>
          <div class="education-text">
            <div class="education-loc">{{education.location}}</div>
            <div class="education-time">{{education.timeperiod}}</div>
          </div>
        </a>
        ...
        <a :href="education.link2" target="_blank" class="item">
          <div class="icon">
            <i class="fa fa-graduation-cap"></i>
          </div>
          <div class="education-text">
        ...
        <div class="right">
          ...
          <div class="prog-outer-outer">
            <div class="prog-outer">
              ...
              <!-- <b-progress :value="skill.level" variant="success" class="mb-2 prog"></b-progress> -->
            </div>
          </div>
        </div>
      </div>
